...
<template>
  <div class="relative">
    <input v-model="value" :placeholder="placeholder" type="text" spellcheck="false" autocapitalize="off" class="glass-input w-full rounded px-3 py-1.5 text-sm outline-none focus:border-blue-400" />
